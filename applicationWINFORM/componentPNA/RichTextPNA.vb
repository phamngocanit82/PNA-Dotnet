...
<ToolboxBitmap(GetType(RichtextStylePNA), "RichText.ico")> _
Public Class RichtextStylePNA
    ...
    Private Sub mnuFindReplace_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles mnuFindReplace.Click
        ...
        _frmFindReplace.frm = Me
        _frmFindReplace.Show(Me)
    End Sub
    ...
    Private Sub tbrFindReplace_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles tbrFindReplace.Click
        ...
        _frmFindReplace.Show(Me)
    End Sub
    Private Sub TextPNA_Validating(ByVal sender As System.Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles TextPNA.Validating
        TextPNA.Rtf = TextPNA.Rtf.Replace("'", "")
    End Sub
End Class
