...
Public Class frmPUSupplierType
    ...
    'Private Sub frmPUSupplierType_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    '    clsPUSupplierType.LoadForm(Me)
    'End Sub
    ''Menu
    ...
    '    row("IDSupplierType") = txtIDSupplierType.Text.Trim
    '    row("SupplierTypeName") = txtName.Text.Trim
    ...
    '    clsPUSupplierType.getRowGrid2(Me)
    'End Sub
End Class