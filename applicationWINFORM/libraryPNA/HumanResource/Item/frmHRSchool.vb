...
Public Class frmHRSchool
    ...
    'Private Sub frmHRSchool_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    '    clsHRSchool.LoadForm(Me)
    'End Sub
    ''Menu
    ...
    '    If e.KeyCode = Windows.Forms.Keys.Enter Then
    '        clsHRSchool.ItemPopupSearch2(Me)
    '    End If
    'End Sub
    ...
    '    If e.KeyCode = Windows.Forms.Keys.Enter Then
    '        clsHRSchool.ItemPopupSearch3(Me)
    '    End If
    'End Sub
