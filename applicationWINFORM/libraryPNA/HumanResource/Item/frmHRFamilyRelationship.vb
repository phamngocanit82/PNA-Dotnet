...
Public Class frmHRFamilyRelationship
    ...
    'Private Sub frmHRFamilyRelationship_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    '    clsHRFamilyRelationship.LoadForm(Me)
    'End Sub
    ''Menu
    ...
    '    row("IDFamilyRelationship") = txtIDFamilyRelationship.Text.Trim
    '    row("FamilyRelationshipName") = txtName.Text.Trim
    ...
    '    clsHRFamilyRelationship.Undo(Me)
    'End Sub
    ''Submenu
    ...
    '    clsHRFamilyRelationship.getRowGrid1(Me)
    'End Sub
