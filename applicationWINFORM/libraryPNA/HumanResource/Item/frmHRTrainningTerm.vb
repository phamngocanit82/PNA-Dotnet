...
Public Class frmHRTrainningTerm
    ...
    'Private Sub frmHRTrainningTerm_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    '    clsHRTrainningTerm.LoadForm(Me)
    'End Sub
    ''Menu
    ...
    '    row("IDTrainningTerm") = txtIDTrainningTerm.Text.Trim
    '    row("TrainningTermName") = txtName.Text.Trim
    ...
    '    clsHRTrainningTerm.getRowGrid1(Me)
    'End Sub
