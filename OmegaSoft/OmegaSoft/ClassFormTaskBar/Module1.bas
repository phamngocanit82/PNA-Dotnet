...
Public Sub AttachForm(mhWnd As Long, ByVal m_width As Integer, ByVal m_height As Integer, Optional intForceWidth As Integer = 0, Optional intForceHeight As Integer = 0, Optional blnGrowWithTray As Boolean = False)
    hwndForm = mhWnd
