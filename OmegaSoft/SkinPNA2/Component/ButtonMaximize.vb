...
'<ToolboxBitmap(GetType(ButtonMaximize), "Maximize0.png")> _
Public Class ButtonMaximize
#Region "ClassButtonMaximize"
#Region "Enum/Struct"
        ...
        Try
            ...
            Select Case _style
                Case StyleButton.Style1
                    _img(0) = New Bitmap(AppAssembly.GetManifestResourceStream("OmegaSkins2.FormFlash13.png"))
                    _img(1) = New Bitmap(AppAssembly.GetManifestResourceStream("OmegaSkins2.FormFlash14.png"))
                    _img(2) = New Bitmap(AppAssembly.GetManifestResourceStream("OmegaSkins2.FormFlash15.png"))
...
#End Region
#Region "Events"
    Private Sub ButtonMaximize_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Width = 22 : Height = 15
        _getResBitmap()
        Refresh()
    End Sub
