...
'<ToolboxBitmap(GetType(ButtonCloseProcess), "Close0.png")> _
Public Class ButtonCloseProcess
#Region "ClassButtonCloseProcess"
#Region "Enum/Struct"
        ...
        Try
            ...
            Select Case _style
                Case StyleButton.Style1
                    _img(0) = New Bitmap(AppAssembly.GetManifestResourceStream("OmegaSkins2.FormProcess01.png"))
                    _img(1) = New Bitmap(AppAssembly.GetManifestResourceStream("OmegaSkins2.FormProcess02.png"))
                    _img(2) = New Bitmap(AppAssembly.GetManifestResourceStream("OmegaSkins2.FormProcess03.png"))
...
#End Region
#Region "Events"
    Private Sub ButtonCloseProcess_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Width = 29 : Height = 11
        _getResBitmap()
        Refresh()
    End Sub
    ...
    Protected Overrides Sub OnResize(ByVal e As System.EventArgs)
        Try
            ...
            gp.AddLine(Width, 0, Width, Height - 2)
            gp.AddLine(Width, Height - 2, Width - 2, Height)
            gp.AddLine(Width - 2, Height, 2, Height)
            gp.AddLine(2, Height, 0, Height - 2)
            gp.AddLine(0, Height - 2, 0, 0)
