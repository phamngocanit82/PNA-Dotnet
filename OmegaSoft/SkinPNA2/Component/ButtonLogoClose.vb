...
'<ToolboxBitmap(GetType(ButtonLogoClose), "Close0.png")> _
Public Class ButtonLogoClose
#Region "ClassButtonLogoClose"
#Region "Enum/Struct"
        ...
        Try
            ...
            Select Case _style
                Case StyleButton.Style1
                    _img(0) = New Bitmap(AppAssembly.GetManifestResourceStream("OmegaSkins2.FormLogo01.png"))
                    _img(1) = New Bitmap(AppAssembly.GetManifestResourceStream("OmegaSkins2.FormLogo02.png"))
                    _img(2) = New Bitmap(AppAssembly.GetManifestResourceStream("OmegaSkins2.FormLogo03.png"))
                Case StyleButton.Style2
                    _img(0) = New Bitmap(AppAssembly.GetManifestResourceStream("OmegaSkins2.FormLogo01.png"))
                    _img(1) = New Bitmap(AppAssembly.GetManifestResourceStream("OmegaSkins2.FormLogo01.png"))
                    _img(2) = New Bitmap(AppAssembly.GetManifestResourceStream("OmegaSkins2.FormLogo01.png"))
...
#End Region
#Region "Events"
    Private Sub ButtonLogoClose_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Width = 46 : Height = 19
        _getResBitmap()
        Refresh()
    End Sub
    ...
    Protected Overrides Sub OnResize(ByVal e As System.EventArgs)
        Try
            ...
            gp.AddLine(Width, 0, Width, Height - 3)
            gp.AddLine(Width, Height - 3, Width - 3, Height)
            gp.AddLine(Width - 3, Height, 3, Height)
            gp.AddLine(3, Height, 0, Height - 3)
            gp.AddLine(0, Height - 3, 0, Height)
