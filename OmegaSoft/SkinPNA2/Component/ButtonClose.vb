...
'<ToolboxBitmap(GetType(ButtonClose), "Close0.png")> _
Public Class ButtonClose
#Region "ClassButtonClose"
#Region "Enum/Struct"
        ...
        Try
            ...
            Select Case _style
                Case StyleButton.Style1
                    _img(0) = New Bitmap(AppAssembly.GetManifestResourceStream("OmegaSkins2.FormFlash10.png"))
                    _img(1) = New Bitmap(AppAssembly.GetManifestResourceStream("OmegaSkins2.FormFlash11.png"))
                    _img(2) = New Bitmap(AppAssembly.GetManifestResourceStream("OmegaSkins2.FormFlash12.png"))
...
#End Region
#Region "Events"
    Private Sub ButtonClose_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Width = 36 : Height = 15
        _getResBitmap()
        Refresh()
    End Sub
    ...
    Protected Overrides Sub OnResize(ByVal e As System.EventArgs)
        Try
            ...
            gp.AddLine(Width - 3, Height, 0, Height)
            gp.AddLine(0, 0, 0, Height)
