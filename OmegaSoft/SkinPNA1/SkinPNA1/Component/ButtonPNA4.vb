...
<ToolboxBitmap(GetType(ButtonPNA4), "ButtonPNA4.bmp")> _
Public Class ButtonPNA4
        ...
        Try
            ...
            Select Case _style
                Case StyleButton.Style1
                    _img(0) = New Bitmap(AppAssembly.GetManifestResourceStream("OmegaSkins1.ButtonSlide01.png"))
                    _img(1) = New Bitmap(AppAssembly.GetManifestResourceStream("OmegaSkins1.ButtonSlide02.png"))
                    _img(2) = New Bitmap(AppAssembly.GetManifestResourceStream("OmegaSkins1.ButtonSlide03.png"))
...
#End Region
#Region "Events"
    Private Sub ButtonPNA4_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Width = 17 : Height = 17
        _getResBitmap()
        _styleButton()
    End Sub
