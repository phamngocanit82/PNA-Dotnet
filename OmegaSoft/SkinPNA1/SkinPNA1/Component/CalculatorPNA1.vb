...
<ToolboxBitmap(GetType(CalculatorPNA1), "CalculatorPNA1.bmp")> _
Public Class CalculatorPNA1
#Region "Variables"
...
#Region "Methods"
    ...
    End Sub
    Private Sub _setNumber(ByVal btn As OmegaSkins1.ButtonPNA2)
        Try
            If _strChr <> "" Then
        ...
        End Try
    End Sub
    Private Sub _setChr(ByVal btn As OmegaSkins1.ButtonPNA2)
        Try
            Select Case btn.Text.Trim
                Case "+", "-", "*", "/"
...
#End Region
#Region "Process"
    Private Sub CalculatorPNA1_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        _reset()
    End Sub
#Region "Others"
