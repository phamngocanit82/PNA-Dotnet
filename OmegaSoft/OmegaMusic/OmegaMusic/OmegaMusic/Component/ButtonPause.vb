...
<ToolboxBitmap(GetType(ButtonPause), "Pause0.png")> _
Public Class ButtonPause
#Region "ClassButtonPause"
#Region "Enum/Struct"
...
#End Region
#Region "Events"
    Private Sub ButtonPause_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Width = 35 : Height = 35
        _getResBitmap()
        Refresh()
    End Sub
