...
Public Class ButtonSeek
#Region "ClassButtonSeek"
#Region "Enum/Struct"
        ...
        Try
            ...
            Select Case _style
                Case StyleButton.Style1
                    _img(0) = New Bitmap(AppAssembly.GetManifestResourceStream("OmegaMusic.Seek0.png"))
                    _img(1) = New Bitmap(AppAssembly.GetManifestResourceStream("OmegaMusic.Seek1.png"))
                    _img(2) = New Bitmap(AppAssembly.GetManifestResourceStream("OmegaMusic.Seek2.png"))
...
#End Region
#Region "Events"
    Private Sub ButtonSeek_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Width = 11 : Height = 9
        _getResBitmap()
        Refresh()
    End Sub
    ...
    Protected Overrides Sub OnResize(ByVal e As System.EventArgs)
        Try
            ...
            gp.AddLine(1, 2, 2, 1)
            gp.AddLine(2, 1, Width - 3, 1)
            gp.AddLine(Width - 3, 1, Width - 1, 3)
            gp.AddLine(Width - 1, 3, Width - 1, Height - 5)
            gp.AddLine(Width - 1, Height - 5, Width - 3, Height - 1)
            gp.AddLine(Width - 3, Height - 1, 3, Height - 1)
            gp.AddLine(3, Height - 1, 1, Height - 5)
            gp.AddLine(1, Height - 5, 1, 2)
