...
<ToolboxBitmap(GetType(ButtonShuffle), "Shuffle0.png")> _
Public Class ButtonShuffle
#Region "ClassButtonShuffle"
#Region "Enum/Struct"
        ...
        Try
            ...
            Select Case _style
                Case StyleButton.Style1
                    _img(0) = New Bitmap(AppAssembly.GetManifestResourceStream("OmegaMusic.Shuffle0.png"))
                    _img(1) = New Bitmap(AppAssembly.GetManifestResourceStream("OmegaMusic.Shuffle1.png"))
                    _img(2) = New Bitmap(AppAssembly.GetManifestResourceStream("OmegaMusic.Shuffle2.png"))
...
#End Region
#Region "Events"
    Private Sub ButtonShuffle_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Width = 21 : Height = 21
        _getResBitmap()
        Refresh()
    End Sub
