...
<ToolboxBitmap(GetType(ButtonStop), "Stop0.png")> _
Public Class ButtonStop
#Region "ClassButtonStop"
#Region "Enum/Struct"
        ...
        Try
            ...
            Select Case _style
                Case StyleButton.Style1
                    _img(0) = New Bitmap(AppAssembly.GetManifestResourceStream("OmegaMusic.Stop0.png"))
                    _img(1) = New Bitmap(AppAssembly.GetManifestResourceStream("OmegaMusic.Stop1.png"))
                    _img(2) = New Bitmap(AppAssembly.GetManifestResourceStream("OmegaMusic.Stop2.png"))
...
#End Region
#Region "Events"
    Private Sub ButtonStop_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Width = 21 : Height = 21
        _getResBitmap()
        Refresh()
    End Sub
