...
<ToolboxBitmap(GetType(ButtonPNA), "ButtonPNA.bmp")> _
Public Class ButtonPNA
#Region "ClassButtonPNA"
#Region "Enum/Struct"
...
#Region "Methods"
    Private Function _isInnerXY() As Boolean
        ...
        End Try
    End Function
    Private Sub _drawImage(ByVal g As Graphics)
        Select Case ImageAlign
            Case ContentAlignment.MiddleLeft
                If Enabled Then
                    g.DrawImage(Image, 5, CInt(Height / 2) - CInt(Image.Height / 2), Image.Width, Image.Height)
                Else
                    ControlPaint.DrawImageDisabled(g, Image, 5, CInt(Height / 2) - CInt(Image.Height / 2), BackColor)
                End If
            Case ContentAlignment.MiddleCenter
                If Enabled Then
                    g.DrawImage(Image, CInt(Width / 2) - CInt(Image.Width / 2), CInt(Height / 2) - CInt(Image.Height / 2), Image.Width, Image.Height)
                Else
                    ControlPaint.DrawImageDisabled(g, Image, CInt(Width / 2) - CInt(Image.Width / 2), CInt(Height / 2) - CInt(Image.Height / 2), BackColor)
                End If
            Case ContentAlignment.MiddleRight
                If Enabled Then
                    g.DrawImage(Image, Width - CInt(Image.Width / 2) - 11, CInt(Height / 2) - CInt(Image.Height / 2), Image.Width, Image.Height)
                Else
                    ControlPaint.DrawImageDisabled(g, Image, Width - CInt(Image.Width / 2) - 11, CInt(Height / 2) - CInt(Image.Height / 2), BackColor)
                End If
        End Select
    End Sub
        ...
        Try
            ...
            Select Case _state
                ...
                Case StateButton.Press
                    ...
                    g.DrawString(Text, Font, New SolidBrush(ForeColor), rc, sf)
            End Select
            If Not Image Is Nothing Then _drawImage(g)
        Catch ex As Exception
        End Try
    End Sub
#Region "Style1"
    ...
    Private Sub _style1MouseMove(ByVal g As Graphics)
        Try
            ...
            _drawTextAndImage(g)
            'Border
            g.DrawRectangle(New Pen(Color.FromArgb(230, 159, 57)), New Rectangle(1, 1, Width - 3, Height - 3))
            g.DrawLine(New Pen(Color.FromArgb(179, 201, 214)), 1, 1, 1, 0)
            g.DrawLine(New Pen(Color.FromArgb(179, 201, 214)), Width - 2, 0, Width - 2, 1)
            g.DrawLine(New Pen(Color.FromArgb(179, 201, 214)), 1, Height - 2, 1, Height - 1)
            g.DrawLine(New Pen(Color.FromArgb(179, 201, 214)), Width - 2, Height - 2, Width - 2, Height - 1)
...
#Region "Style2"
    ...
    Private Sub _style2MouseMove(ByVal g As Graphics)
        Try
            ...
            _drawTextAndImage(g)
            'Border
            g.DrawRectangle(New Pen(Color.FromArgb(255, 214, 56)), New Rectangle(1, 1, Width - 3, Height - 3))
            g.DrawLine(New Pen(Color.FromArgb(179, 201, 214)), 1, 1, 1, 0)
            g.DrawLine(New Pen(Color.FromArgb(179, 201, 214)), Width - 2, 0, Width - 2, 1)
            g.DrawLine(New Pen(Color.FromArgb(179, 201, 214)), 1, Height - 2, 1, Height - 1)
            g.DrawLine(New Pen(Color.FromArgb(179, 201, 214)), Width - 2, Height - 2, Width - 2, Height - 1)
...
#Region "Style3"
    ...
    Private Sub _style3MouseMove(ByVal g As Graphics)
        Try
            ...
            _drawTextAndImage(g)
            'Border
            g.DrawRectangle(New Pen(Color.FromArgb(0, 245, 0)), New Rectangle(1, 1, Width - 3, Height - 3))
            g.DrawLine(New Pen(Color.FromArgb(179, 201, 214)), 1, 1, 1, 0)
            g.DrawLine(New Pen(Color.FromArgb(179, 201, 214)), Width - 2, 0, Width - 2, 1)
            g.DrawLine(New Pen(Color.FromArgb(179, 201, 214)), 1, Height - 2, 1, Height - 1)
            g.DrawLine(New Pen(Color.FromArgb(179, 201, 214)), Width - 2, Height - 2, Width - 2, Height - 1)
...
#End Region
#Region "Events"
    Private Sub ButtonPNA_GotFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.GotFocus
        _bolFocus = True
        Invalidate()
    End Sub
    Private Sub ButtonPNA_LostFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.LostFocus
        _bolFocus = False
        Invalidate()
    End Sub
    Protected Overrides Sub OnKeyDown(ByVal e As System.Windows.Forms.KeyEventArgs)
        Try
            If (_state <> StateButton.Press And e.KeyCode = Keys.Space) Or (_state <> StateButton.Press And e.KeyCode = Keys.Enter) Then
